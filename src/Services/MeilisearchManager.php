...
final class MeilisearchManager
{
    ...
    private ContainerInterface $documentProviders;
    ...
    public function __construct(NormalizerInterface $normalizer, Engine $engine, PropertyAccessorInterface $propertyAccessor, array $configuration, ContainerInterface $documentProviders)
    {
    ...
    public function getDocumentProvider(string $indice): DocumentProviderInterface
    {
        return $this->documentProviders->get($indice);
    }
...
//        return $results;
    ...
    private function setSearchable(): void
    {
